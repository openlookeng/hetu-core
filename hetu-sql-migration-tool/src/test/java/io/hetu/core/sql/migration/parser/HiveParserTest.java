...
public class HiveParserTest
{
    ...
    private HiveParser hiveParserUnderTest;

    @BeforeMethod
    public void setUp()
    {
        initMocks(this);
        hiveParserUnderTest = new HiveParser(mockOptions);
    }
    ...
    {
        // Setup
        final Function<HiveSqlParser, ParserRuleContext> parseFunction = val -> {
        ...
        // Run the test
        final JSONObject result = hiveParserUnderTest.invokeParser("sql", parseFunction, parsingOptions);
