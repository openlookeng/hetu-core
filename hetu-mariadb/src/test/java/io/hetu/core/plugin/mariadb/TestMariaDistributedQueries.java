...
@Test
public class TestMariaDistributedQueries
        extends AbstractTestDistributedQueries
{
    private final TestingMySqlServer mysqlServer;

    public TestMariaDistributedQueries()
            throws Exception
    {
        this(MariaQueryRunner.createTestingMariaServer("testuser", "testpass", "tpch"));
    }

    public TestMariaDistributedQueries(TestingMySqlServer mysqlServer)
    {
        super(() -> createMariaQueryRunner(mysqlServer, ImmutableMap.of(), TpchTable.getTables()));
    ...
    * */
    ...
    {
        // MariaDB connector currently does not support comment on table
    ...
    // MariaDB specific tests should normally go in TestMySqlIntegrationSmokeTest
}
