...
@Test
public class TestMariaTypeMapping
        extends AbstractTestQueryFramework
{
    ...
    public TestMariaTypeMapping()
            throws Exception
    {
        this(MariaQueryRunner.createTestingMariaServer("testuser", "testpass", "tpch"));
    }

    private TestMariaTypeMapping(TestingMySqlServer mysqlServer)
    {
        super(() -> createMariaQueryRunner(mysqlServer, ImmutableMap.of(), ImmutableList.of()));
    ...
    @Test
    public void testMariaCreatedParameterizedVarchar()
    {
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), mariaCreateAndInsert("tpch.maria_test_parameterized_varchar"));
    }

    @Test
    public void testMariaCreatedParameterizedVarcharUnicode()
    {
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), mariaCreateAndInsert("tpch.maria_test_parameterized_varchar_unicode"));
    }
    ...
    {
        mariaCharTypeTest()
                .execute(getQueryRunner(), prestoCreateAsSelect("maria_test_parameterized_char"));
    }
    ...
    {
        mariaCharTypeTest()
                .execute(getQueryRunner(), mariaCreateAndInsert("tpch.maria_test_parameterized_char"));
    }

    private DataTypeTest mariaCharTypeTest()
    {
    ...
    @Test
    public void testMariaCreatedParameterizedCharUnicode()
    {
        DataTypeTest.create()
    ...
    @Test
    public void testMariaCreatedDecimal()
    {
        decimalTests()
                .execute(getQueryRunner(), mariaCreateAndInsert("tpch.test_decimal"));
    }
    ...
    public void testDate()
    {
        ...
        for (String timeZoneId : ImmutableList.of(UTC_KEY.getId(), jvmZone.getId(), someZone.getId())) {
            Session session = Session.builder(getQueryRunner().getDefaultSession())
                    ...
                    .build();
            testCases.execute(getQueryRunner(), session, mariaCreateAndInsert("tpch.test_date"));
    ...
    {
        // TODO Maria datetime is not correctly read (see comment in StandardColumnMappings.timestampColumnMappingUsingSqlTimestamp)
    }

    @Test
    public void testTimestamp()
    {
        // TODO Maria timestamp is not correctly read (see comment in StandardColumnMappings.timestampColumnMappingUsingSqlTimestamp)
    }
    ...
    public void testJson()
    {
        ...
        jsonTestCases(jsonDataType(value -> format("CAST(%s AS JSON)", formatStringLiteral(value))))
                .execute(getQueryRunner(), mariaCreateAndInsert("tpch.maria_test_json"));
    }
    ...
    private DataSetup mariaCreateAndInsert(String tableNamePrefix)
    {
