...
public class MariaSqlStatementWriter
        extends BaseJdbcSqlStatementWriter
{
    public MariaSqlStatementWriter(JdbcPushDownParameter pushDownParameter)
    {
        super(pushDownParameter);
    }

    /**
     * Maria doesn't support NULLS FIRST & NULLS LAST in ORDER BY section, so
