...
public class MariaPushDownUtils
{
    private MariaPushDownUtils() {}

    public static String getCastExpression(String expression, Type type)
    {
        // Maria only support cast type:[DATE, DATETIME, TIME, CHAR, SIGNED, UNSIGNED, BINARY, DECIMAL]
    ...
    public static String toNativeType(Type type)
    {
        ...
        throw new PrestoException(JDBC_QUERY_GENERATOR_FAILURE, "Maria does not support cast the type " + type);
    }
}
