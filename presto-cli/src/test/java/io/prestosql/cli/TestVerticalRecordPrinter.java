...
public class TestVerticalRecordPrinter
{
            ...
            throws Exception
    {
        ...
        printer.printRows(TestAlignedTablePrinter.rows(
            ...
            throws Exception
    {
        ...
        printer.printRows(TestAlignedTablePrinter.rows(
                TestAlignedTablePrinter.row("hello", TestAlignedTablePrinter.bytes("hello"), "world"),
                TestAlignedTablePrinter.row("a", TestAlignedTablePrinter.bytes("some long text that is more than 16 bytes"), "b"),
                TestAlignedTablePrinter.row("cat", TestAlignedTablePrinter.bytes(""), "dog")),
                true);
        printer.finish();
