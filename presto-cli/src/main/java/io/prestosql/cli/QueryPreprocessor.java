...
{
    public static final String ENV_PREPROCESSOR = "OPENLOOKENG_PREPROCESSOR";
    public static final String ENV_PREPROCESSOR_TIMEOUT = "OPENLOOKENG_PREPROCESSOR_TIMEOUT";
    public static final String ENV_PRESTO_CATALOG = "OPENLOOKENG_CATALOG";
    public static final String ENV_PRESTO_SCHEMA = "OPENLOOKENG_SCHEMA";
