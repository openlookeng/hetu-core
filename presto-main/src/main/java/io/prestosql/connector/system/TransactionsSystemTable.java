        ...
        implements SystemTable
{
    ...
    public TransactionsSystemTable(Metadata metadata, TransactionManager transactionManager)
    {
        this.transactionsTable = tableMetadataBuilder(TRANSACTIONS_TABLE_NAME)
                ...
                .column("catalogs", metadata.getFunctionAndTypeManager().getParameterizedType(ARRAY, ImmutableList.of(TypeSignatureParameter.of(createUnboundedVarcharType().getTypeSignature()))))
                .build();
