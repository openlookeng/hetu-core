...
{
    public static final RecoveryUtils NOOP_SNAPSHOT_UTILS;
    ...
    static {
        ...
        NOOP_SNAPSHOT_UTILS = new RecoveryUtils(fileSystemClientManager, recoveryConfig, new InMemoryNodeManager());
