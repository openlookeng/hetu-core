        ...
        extends EventListenerManager
{
    ...
    /**
     * Presto Listener requires custom properties to create the listener object.
     */
    private Map<String, String> properties = ImmutableMap.of();

    /**
     * Set the custom properties before installing the plugin object.
     *
     * @param properties the listener properties
     */
    ...
    {
        configuredEventListener.set(Optional.of(eventListenerFactory.create(properties)));  // Use user defined properties
    }
