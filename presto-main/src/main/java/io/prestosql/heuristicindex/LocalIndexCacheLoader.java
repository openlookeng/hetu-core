        ...
        extends CacheLoader<IndexCacheKey, List<SplitIndexMetadata>>
{
    ...
    protected static Properties getIndexStoreProperties()
    {
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_URI)) {
            properties.setProperty(HetuConstant.INDEXSTORE_URI.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_TYPE)) {
            properties.setProperty(HetuConstant.INDEXSTORE_TYPE.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_HDFS_CONFIG_RESOURCES)) {
            properties.setProperty(HetuConstant.INDEXSTORE_HDFS_CONFIG_RESOURCES.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_HDFS_AUTHENTICATION_TYPE)) {
            properties.setProperty(HetuConstant.INDEXSTORE_HDFS_AUTHENTICATION_TYPE.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_CONFIG_PATH)) {
            properties.setProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_CONFIG_PATH.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_KEYTAB_PATH)) {
            properties.setProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_KEYTAB_PATH.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
        ...
        if (PropertyService.containsProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_PRINCIPAL)) {
            properties.setProperty(HetuConstant.INDEXSTORE_HDFS_KRB5_PRINCIPAL.replaceFirst(HetuConstant.INDEXSTORE_KEYS_PREFIX, ""),
