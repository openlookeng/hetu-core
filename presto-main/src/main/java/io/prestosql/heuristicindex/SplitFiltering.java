...
public class SplitFiltering
{
    ...
    private static List<Split> filterUsingForwardIndex(Expression expression, List<Split> inputSplits, String fullQualifiedTableName, Set<String> referencedColumns, HeuristicIndexerManager indexerManager)
    {
    ...
    private static List<Split> filterUsingInvertedIndex(Expression expression, List<Split> inputSplits, String fullQualifiedTableName, Set<String> referencedColumns, HeuristicIndexerManager indexerManager)
    {
        try {
     ...
     */
    public static Pair<Optional<Expression>, Map<Symbol, ColumnHandle>> getExpression(SqlStageExecution stage)
    {
        List<PlanNode> filterNodeOptional = getFilterNode(stage);
