        ...
        extends JoinProbe
{
    ...
    public UnSpilledJoinProbe(int[] probeOutputChannels, Page page, List<Integer> probeJoinChannels, OptionalInt probeHashChannel, Page probePage, LookupSource lookupSource, @Nullable Block probeHashBlock)
    {
        super(probeOutputChannels, page, probeJoinChannels, probeHashChannel);
