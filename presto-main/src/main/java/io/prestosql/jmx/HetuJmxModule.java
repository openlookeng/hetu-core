        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        configBinder(binder).bindConfig(HetuJmxConfig.class);
            ...
            implements Provider<ServiceAnnouncement>
    {
        ...
        {
            return serviceAnnouncement("jmx").addProperty("jmx", hetuJmxAgent.getUrl().toString()).build();
        }
    }
}
