        ...
        extends ProjectOffPushDownRule<SampleNode>
{
    ...
    @Override
    protected Optional<PlanNode> pushDownProjectOff(PlanNodeIdAllocator idAllocator, SampleNode sampleNode, Set<Symbol> referencedOutputs)
    {
        return restrictChildOutputs(idAllocator, sampleNode, referencedOutputs);
    }
}
