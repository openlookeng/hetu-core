        ...
        extends ProjectOffPushDownRule<IndexJoinNode>
{
    ...
    @Override
    protected Optional<PlanNode> pushDownProjectOff(PlanNodeIdAllocator idAllocator, IndexJoinNode indexJoinNode, Set<Symbol> referencedOutputs)
    {
        ...
        return restrictChildOutputs(idAllocator, indexJoinNode, probeInputs.build(), indexInputs.build());
    }
}
