...
public class DistributedExecutionPlanner
{
            ...
            extends InternalPlanVisitor<Map<PlanNodeId, SplitSource>, Void>
    {
        ...
        @Override
        public Map<PlanNodeId, SplitSource> visitCacheTableWriter(CacheTableWriterNode node, Void context)
        {
            return node.getSource().accept(this, context);
        }
        ...
        @Override
        public Map<PlanNodeId, SplitSource> visitCacheTableFinish(CacheTableFinishNode node, Void context)
        {
            return node.getSource().accept(this, context);
        }
        ...
        @Override
        public Map<PlanNodeId, SplitSource> visitUpdateIndex(UpdateIndexNode node, Void context)
        {
            return node.getSource().accept(this, context);
        }
