        ...
        extends ProjectOffPushDownRule<ApplyNode>
{
            ...
            Set<Symbol> referencedOutputs)
    {
        ...
        for (Map.Entry<Symbol, RowExpression> entry : applyNode.getSubqueryAssignments().entrySet()) {
        ...
        Optional<PlanNode> newSubquery = restrictOutputs(idAllocator, applyNode.getSubquery(), requiredAssignmentsSymbols.build(), false, null);
        ...
        Optional<PlanNode> newInput = restrictOutputs(idAllocator, applyNode.getInput(), requiredInputSymbols, false, null);
