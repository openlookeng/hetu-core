...
public final class RowExpressionOptimizer
{
    ...
    public RowExpression optimize(RowExpression rowExpression, RowExpressionInterpreter.Level level, ConnectorSession session)
    {
    ...
    public Object optimize(RowExpression expression, RowExpressionInterpreter.Level level, ConnectorSession session, Function<VariableReferenceExpression, Object> variableResolver)
    {
