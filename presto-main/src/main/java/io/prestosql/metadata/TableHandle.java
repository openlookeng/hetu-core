...
public final class TableHandle
{
    ...
    /**
     * Hetu requires {@link ConnectorTableHandle#getSchemaPrefixedTableName()} but not
     * all the connectors which provide the implementation have access to the catalog
     * name.
     * <p>
     * Since this class contains the catalog name, it will prefix the output from
     * {@link ConnectorTableHandle#getSchemaPrefixedTableName()} to provide a fully qualified
     * name.
     * </p>
     *
     * @return the fully qualified table name prefixed with catalog name
     */
    ...
    public int hashCode()
    {
        return Objects.hash(this.getConnectorHandle().getSchemaPrefixedTableName())
                + Objects.hash(this.catalogName.toString());
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (tableHandle.getConnectorHandle().getSchemaPrefixedTableName()
                .equalsIgnoreCase(this.getConnectorHandle().getSchemaPrefixedTableName())
