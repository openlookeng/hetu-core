        ...
        implements NodeAllocatorService
{
            ...
            implements NodeAllocator
    {
        ...
        {
            NodeSelector nodeSelector = nodeSelectorCache.computeIfAbsent(requirements.getCatalogName(), catalogName -> nodeScheduler.createNodeSelector(catalogName.isPresent() ? catalogName.get() : null, false, ImmutableMap.of()));
