...
public class ClusterSizeMonitor
{
            ...
            Duration executionMaxWait)
    {
        ...
        //TODO remove following after Discovery Service AA mode Implemented
        PropertyService.setProperty(DynamicSplitPlacementPolicy.QUERY_MANAGER_REQUIRED_WORKERS_MAX_WAIT, executionMaxWait);
    }
