...
public class QueryTracker<T extends TrackedQuery>
{
            ...
            try {
                ...
                if (isAbandoned(query)) {
                    ...
                    query.fail(new PrestoException(
                            ABANDONED_QUERY,
                            String.format("Query %s has not been accessed since %s: currentTime %s",
                                    query.getQueryId(),
    ...
    {
        if (query.isRunningAsync()) {
            //Query is running in async. Its not abandoned.
            return false;
        }
    ...
    public interface TrackedQuery
    {
        ...
        default boolean isRunningAsync()
        {
            return false;
        }
    }
