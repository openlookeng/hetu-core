        ...
        extends SqlQueryExecution
{
    ...
    public CachedSqlQueryExecution(QueryPreparer.PreparedQuery preparedQuery, List<QueryPreparer.PreparedQuery> preparedQueryList, QueryStateMachine stateMachine,
    ...
    {
        super(preparedQuery, preparedQueryList, stateMachine, slug, metadata, cubeManager, accessControl, sqlParser, splitManager,
