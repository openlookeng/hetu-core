...
public class TestExpressionDeterminismEvaluator
{
    ...
    public void testSanity()
    {
        ...
        assertFalse(ExpressionDeterminismEvaluator.isDeterministic(function("shuffle", ImmutableList.of(new ArrayType(VARCHAR)), ImmutableList.of(new NullLiteral()))));
        assertFalse(ExpressionDeterminismEvaluator.isDeterministic(function("uuid")));
        assertTrue(ExpressionDeterminismEvaluator.isDeterministic(function("abs", ImmutableList.of(DOUBLE), ImmutableList.of(input("symbol")))));
        assertFalse(ExpressionDeterminismEvaluator.isDeterministic(function("abs", ImmutableList.of(DOUBLE), ImmutableList.of(function("rand")))));
        assertTrue(ExpressionDeterminismEvaluator.isDeterministic(function(
                "abs",
