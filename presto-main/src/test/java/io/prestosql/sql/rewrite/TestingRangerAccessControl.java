...
public class TestingRangerAccessControl
        implements AccessControl
{
    ...
    {
        if (tableName.toString().equals("tpch.s1.t3") && columnName.equals("c")) {
            return "regexp_replace(c,'(\\w)','*')";
        }

        if (tableName.toString().equals("tpch.s1.t4") && columnName.equals("a")) {
            return "regexp_replace(a,'(\\w)','*')";
        }

        if (tableName.toString().equals("tpch.s1.t5") && columnName.equals("b")) {
            return "IF(length(b)-3>0,rpad(substr(b,1,3),length(b),'*'),substr(b,1,3))";
        }
    ...
    {
        if (tableName.toString().equals("tpch.s1.t1")) {
            return "a>1";
        }
        if (tableName.toString().equals("tpch.s1.t5")) {
            return "a>1";
        }
        return null;
    }
