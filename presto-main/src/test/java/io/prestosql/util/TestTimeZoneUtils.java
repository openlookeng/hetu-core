...
public class TestTimeZoneUtils
{
    ...
    public void test()
    {
        ...
        for (String zoneId : new TreeSet<>(jdkZones)) {
            if (zoneId.equalsIgnoreCase("America/Nuuk") || zoneId.startsWith("Etc/") || zoneId.startsWith("GMT") || zoneId.startsWith("SystemV/")) {
                continue;
            }

            if (zoneId.equals("Canada/East-Saskatchewan") || zoneId.equals("Asia/Qostanay")) {
