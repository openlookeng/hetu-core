...
import io.prestosql.protocol.FullSmileResponseHandler.SmileResponse;
...
public class TestFullSmileResponseHandler
{
    ...
    public void testInvalidSmile()
    {
        ...
        assertEquals(response.getException().getCause().getMessage(), "Invalid SMILE bytes for [simple type, class io.prestosql.protocol.TestFullSmileResponseHandler$User]");
