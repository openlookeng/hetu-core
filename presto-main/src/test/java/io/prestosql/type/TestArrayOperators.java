        ...
        extends AbstractTestFunctions
{
    ...
    public void testArrayToJson()
    {
        ...
        assertFunction(
                ...
                JSON,
                format("[\"%s\",null]", sqlTimestampOf(1970, 1, 1, 0, 0, 1, 0)));
        assertFunction(
    ...
    public void testConstructor()
    {
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(1970, 1, 1, 0, 0, 1, 0),
                        sqlTimestampOf(1973, 7, 8, 22, 0, 1, 0)));
    ...
    public void testArrayJoin()
    {
        ...
        assertFunction(
                ...
                VARCHAR,
                sqlTimestampOf(1970, 1, 1, 0, 0, 1, 0).toString());
        assertFunction(
                "ARRAY_JOIN(ARRAY [null, TIMESTAMP '1970-01-01 00:00:01'], '|', 'XYZ')",
                VARCHAR,
                "XYZ|" + sqlTimestampOf(1970, 1, 1, 0, 0, 1, 0).toString());
    ...
    public void testSort()
    {
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(1970, 1, 1, 0, 0, 1, 0),
                        sqlTimestampOf(1973, 7, 8, 22, 0, 1, 0),
                        sqlTimestampOf(1989, 2, 6, 12, 0, 0, 0)));
            ...
            throws ParseException
    {
        ...
        assertFunction(
                ...
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 3, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 6, 10, 0)));
        assertFunction(
                "SEQUENCE(timestamp '2016-04-16 01:10:10', timestamp '2016-04-16 01:03:00', interval '-3' minute)",
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 10, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 7, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 4, 10, 0)));
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 0, 30, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 0, 50, 0)));
        assertFunction(
                "SEQUENCE(timestamp '2016-04-16 01:01:10', timestamp '2016-04-16 01:00:20', interval '-20' second)",
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 1, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 0, 50, 0),
                        sqlTimestampOf(2016, 4, 16, 1, 0, 30, 0)));
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 16, 20, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 17, 15, 0, 10, 0)));
        assertFunction(
                "SEQUENCE(timestamp '2016-04-16 01:00:10', timestamp '2016-04-14 01:00:20', interval '-19' hour)",
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 15, 6, 0, 10, 0),
                        sqlTimestampOf(2016, 4, 14, 11, 0, 10, 0)));
            ...
            throws ParseException
    {
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 6, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2016, 8, 16, 1, 0, 10, 0)));
        assertFunction(
                "SEQUENCE(timestamp '2016-09-16 01:10:10', timestamp '2016-04-16 01:00:00', interval '-2' month)",
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 9, 16, 1, 10, 10, 0),
                        sqlTimestampOf(2016, 7, 16, 1, 10, 10, 0),
                        sqlTimestampOf(2016, 5, 16, 1, 10, 10, 0)));
        ...
        assertFunction(
                ...
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2018, 4, 16, 1, 0, 10, 0),
                        sqlTimestampOf(2020, 4, 16, 1, 0, 10, 0)));
        assertFunction(
                "SEQUENCE(timestamp '2016-04-16 01:01:10', timestamp '2011-04-16 01:00:00', interval '-2' year)",
                new ArrayType(TIMESTAMP),
                ImmutableList.of(
                        sqlTimestampOf(2016, 4, 16, 1, 1, 10, 0),
                        sqlTimestampOf(2014, 4, 16, 1, 1, 10, 0),
                        sqlTimestampOf(2012, 4, 16, 1, 1, 10, 0)));
