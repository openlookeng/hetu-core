...
public class TestTypeCoercion
{
    ...
    @Test
    public void testCanCoerceWithCast()
    {
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, TINYINT)));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, SMALLINT)));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, BIGINT)));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, REAL)));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, DOUBLE)));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, createType("decimal(23,1)"))));
        assertTrue((typeCoercion.canCoerceWithCast(INTEGER, VARCHAR)));
        assertFalse(typeCoercion.canCoerceWithCast(INTEGER, TIMESTAMP));

        assertTrue((typeCoercion.canCoerceWithCast(DATE, VARCHAR)));
        assertTrue((typeCoercion.canCoerceWithCast(DATE, TIMESTAMP)));
        assertTrue((typeCoercion.canCoerceWithCast(DATE, TIMESTAMP_WITH_TIME_ZONE)));
        assertFalse(typeCoercion.canCoerceWithCast(DATE, INTEGER));

        assertTrue((typeCoercion.canCoerceWithCast(TIME, VARCHAR)));
        assertTrue((typeCoercion.canCoerceWithCast(TIME, TIMESTAMP)));
        assertTrue((typeCoercion.canCoerceWithCast(TIME, TIMESTAMP_WITH_TIME_ZONE)));
        assertFalse(typeCoercion.canCoerceWithCast(TIME, INTEGER));

        assertTrue((typeCoercion.canCoerceWithCast(TIMESTAMP, VARCHAR)));
        assertTrue((typeCoercion.canCoerceWithCast(TIMESTAMP, DATE)));
        assertTrue((typeCoercion.canCoerceWithCast(TIMESTAMP, TIME)));
        assertTrue((typeCoercion.canCoerceWithCast(TIMESTAMP, TIME_WITH_TIME_ZONE)));
        assertFalse(typeCoercion.canCoerceWithCast(TIMESTAMP, INTEGER));

        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, TINYINT)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, BIGINT)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, REAL)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, DOUBLE)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, createType("decimal(23,1)"))));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, VARBINARY)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, DATE)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, TIME)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, TIMESTAMP)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, TIME_WITH_TIME_ZONE)));
        assertTrue((typeCoercion.canCoerceWithCast(VARCHAR, TIMESTAMP_WITH_TIME_ZONE)));
    }
