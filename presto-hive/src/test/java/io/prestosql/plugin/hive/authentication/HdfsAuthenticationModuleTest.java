...
public class HdfsAuthenticationModuleTest
{
    private HdfsAuthenticationModule hdfsAuthenticationModuleUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        hdfsAuthenticationModuleUnderTest = new HdfsAuthenticationModule();
        HashMap<String, String> stringStringHashMap = new HashMap<>();
        hdfsAuthenticationModuleUnderTest.setConfigurationFactory(new ConfigurationFactory(stringStringHashMap));
        hdfsAuthenticationModuleUnderTest.configure(new Binder());
    }
    ...
    public void testSetup() throws Exception
    {
        // Setup
        // Run the test
        hdfsAuthenticationModuleUnderTest.setup(new Binder());
