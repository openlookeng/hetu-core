...
public class TestHiveFileBasedSecurity
{
            ...
            throws Exception
    {
        ...
        queryRunner = HiveQueryRunner.createQueryRunner(ImmutableList.of(NATION), ImmutableMap.of(), "file", ImmutableMap.of("security.config-file", path), Optional.empty(), false);
    }
