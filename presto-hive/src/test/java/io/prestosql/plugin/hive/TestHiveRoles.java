        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        assertQueryFails(createAdminSession(), "CREATE ROLE all", "Role name cannot be one of the reserved roles \\(case insensitive\\): \\[all, default, none\\]");
        assertQueryFails(createAdminSession(), "CREATE ROLE default", "Role name cannot be one of the reserved roles \\(case insensitive\\): \\[all, default, none\\]");
        assertQueryFails(createAdminSession(), "CREATE ROLE none", "Role name cannot be one of the reserved roles \\(case insensitive\\): \\[all, default, none\\]");
        assertQueryFails(createAdminSession(), "CREATE ROLE None", "Role name cannot be one of the reserved roles \\(case insensitive\\): \\[all, default, none\\]");
    }
