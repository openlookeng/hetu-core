...
public class CachingKerberosHadoopAuthenticationTest
{
    @Mock
    private KerberosHadoopAuthentication mockDelegate;

    private CachingKerberosHadoopAuthentication cachingKerberosHadoopAuthenticationUnderTest;
...
//        KerberosHadoopAuthentication kerberosHadoopAuthentication = KerberosHadoopAuthentication.createKerberosHadoopAuthentication(kerberosAuthentication, hdfsConfigurationInitializer);
    ...
    @Test
    public void testGetUserGroupInformation()
    {
        cachingKerberosHadoopAuthenticationUnderTest.getUserGroupInformation();
    }
}
