...
public class TestGlueInputConverter
{
    ...
    private final Table testTbl = TestingMetastoreObjects.getPrestoTestTable(testDb.getDatabaseName());
    private final Partition testPartition = TestingMetastoreObjects.getPrestoTestPartition(testDb.getDatabaseName(), testTbl.getTableName(), ImmutableList.of("val1"));
