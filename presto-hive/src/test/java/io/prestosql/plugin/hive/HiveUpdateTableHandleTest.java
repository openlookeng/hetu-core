...
public class HiveUpdateTableHandleTest
{
    @Mock
    ...
    private HiveUpdateTableHandle hiveUpdateTableHandleUnderTest;

    @Test
    public void setUp() throws Exception
    {
        initMocks(this);
        hiveUpdateTableHandleUnderTest = new HiveUpdateTableHandle("schemaName", "tableName",
