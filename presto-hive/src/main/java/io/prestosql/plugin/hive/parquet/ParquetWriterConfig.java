...
public class ParquetWriterConfig
{
    ...
    private DataSize blockSize = new DataSize(ParquetWriter.DEFAULT_BLOCK_SIZE, DataSize.Unit.BYTE);
    private DataSize pageSize = new DataSize(ParquetWriter.DEFAULT_PAGE_SIZE, DataSize.Unit.BYTE);
