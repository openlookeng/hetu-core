...
import static io.prestosql.orc.OrcWriter.OrcOperation.INSERT;
...
public abstract class AbstractHiveAcidWriters
{
            ...
            AcidOperation updateKind)
    {
        ...
        if (originalFile) {
            ...
            this.bucketFilename = format("bucket_%05d", !bucketNumber.isPresent() ? 0 : bucketNumber.getAsInt());
        }
        else {
