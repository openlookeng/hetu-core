        ...
        implements HiveMetastore
{
    ...
    public Optional<Table> getTable(String databaseName, String tableName)
    {
        return delegate.getTable(databaseName, tableName).map(table -> {
            if (ThriftMetastoreUtil.isAvroTableWithSchemaSet(table) || ThriftMetastoreUtil.isCsvTable(table)) {
                return ThriftMetastoreUtil.fromMetastoreApiTable(table, delegate.getFields(databaseName, tableName).get());
            }
    ...
    {
        delegate.createDatabase(ThriftMetastoreUtil.toMetastoreApiDatabase(database));
    }
    ...
    {
        delegate.createTable(ThriftMetastoreUtil.toMetastoreApiTable(table, principalPrivileges));
    }
    ...
    {
        alterTable(databaseName, tableName, ThriftMetastoreUtil.toMetastoreApiTable(newTable, principalPrivileges));
    }
