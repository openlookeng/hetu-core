...
public class PrestoS3ClientFactory
{
    ...
    private static final String S3_USER_AGENT_SUFFIX = "presto";
    private static final String S3_USER_AGENT_SUFFIX_SELECT = "presto-select";
    ...
    synchronized AmazonS3 getS3Client(Configuration config, HiveConfig hiveConfig)
    {
        ...
        ClientConfiguration clientConfiguration = new ClientConfiguration()
                ...
                .withUserAgentSuffix(hiveConfig.isS3SelectPushdownEnabled() ? S3_USER_AGENT_SUFFIX_SELECT : S3_USER_AGENT_SUFFIX);
