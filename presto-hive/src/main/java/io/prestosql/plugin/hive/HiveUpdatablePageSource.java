        ...
        implements UpdatablePageSource
{
    ...
    Block createRowIdBlock(int positionCount)
    {
        ...
        if (insertRowCounter >= maxNumberOfRowsPerSplit) {
            throw new PrestoException(GENERIC_INSUFFICIENT_RESOURCES, format("Trying to insert too many rows in a single split, max allowed is %d per split", maxNumberOfRowsPerSplit));
        }
