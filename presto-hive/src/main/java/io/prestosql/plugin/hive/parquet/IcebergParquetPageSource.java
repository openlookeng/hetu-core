...
public class IcebergParquetPageSource
        implements ConnectorPageSource
{
    ...
    public IcebergParquetPageSource(ParquetReader parquetReader, List<Type> types, List<Optional<Field>> fields)
    {
     ...
     */
    public IcebergParquetPageSource(
            ...
            implements LazyBlockLoader
    {
        ...
        public Block load()
        {
            ...
            try {
                ...
                throw new PrestoException(HIVE_BAD_DATA, format("Corrupted parquet data; source=%s; %s", parquetDataSourceId, e.getMessage()), e);
            }
            catch (IOException e) {
                throw new PrestoException(HIVE_CURSOR_ERROR, format("Failed reading parquet data; source= %s; %s", parquetDataSourceId, e.getMessage()), e);
            }
