...
public class StorageFormat
{
    ...
    {
        if (serDe == null) {
            throw new PrestoException(HiveErrorCode.HIVE_INVALID_METADATA, "SerDe is not present in StorageFormat");
        }
        return serDe;
    }
    ...
    {
        if (inputFormat == null) {
            throw new PrestoException(HiveErrorCode.HIVE_UNSUPPORTED_FORMAT, "InputFormat is not present in StorageFormat");
        }
        return inputFormat;
    }
    ...
    public String getOutputFormat()
    {
        if (outputFormat == null) {
            throw new PrestoException(HiveErrorCode.HIVE_UNSUPPORTED_FORMAT, "OutputFormat is not present in StorageFormat");
        }
        return outputFormat;
    }
    ...
    public static StorageFormat fromHiveStorageFormat(BaseStorageFormat hiveStorageFormat)
    {
