        ...
        implements ConnectorPageSinkProvider
{
    ...
    public ConnectorPageSink createPageSink(ConnectorTransactionHandle transaction, ConnectorSession session, ConnectorVacuumTableHandle tableHandle)
    {
        ...
        return createPageSink(handle, false, HiveACIDWriteType.VACUUM, session, ImmutableMap.of());
    }
                                             ...
                                             Map<String, String> additionalTableParameters)
    {
        ...
        HiveWriterFactory writerFactory = new HiveWriterFactory(
                ...
                locationService,
                session.getQueryId(),
                new HivePageSinkMetadataProvider(handle.getPageSinkMetadata(), CachingHiveMetastore.memoizeMetastore(metastore, perTransactionMetastoreCacheMaximumSize)),
                typeManager,
                hdfsEnvironment,
                pageSorter,
