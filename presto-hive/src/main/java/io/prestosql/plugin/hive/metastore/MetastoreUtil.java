...
public class MetastoreUtil
{
            ...
            List<Column> partitionKeys)
    {
        ...
        insertPartitionIntoProperties(partitionKeys, schema);
    ...
    public static void insertPartitionIntoProperties(List<Column> partitionColumns, Properties schema)
    {
        StringBuilder partString = new StringBuilder();
        String partStringSep = "";
        StringBuilder partTypesString = new StringBuilder();
        String partTypesStringSep = "";
        for (Column partKey : partitionColumns) {
