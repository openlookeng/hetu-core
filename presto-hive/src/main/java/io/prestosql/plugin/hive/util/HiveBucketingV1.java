...
public final class HiveBucketingV1
{
    private HiveBucketingV1() {}

    public static int getBucketHashCode(List<TypeInfo> types, Page page, int position)
    {
        return getBucketHashCode(types, page, position, page.getChannelCount());
    }

    public static int getBucketHashCode(List<TypeInfo> types, Page page, int position, int channelCount)
    {
        checkArgument(types.size() == channelCount);
        int result = 0;
    ...
    public static int getBucketHashCode(List<TypeInfo> types, Object[] values)
    {
