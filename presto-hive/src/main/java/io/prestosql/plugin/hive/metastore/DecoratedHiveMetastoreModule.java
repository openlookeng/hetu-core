...
import io.prestosql.plugin.hive.metastore.cache.ImpersonationCachingConfig;
import io.prestosql.plugin.hive.metastore.cache.SharedHiveMetastoreCache;
import io.prestosql.plugin.hive.metastore.cache.SharedHiveMetastoreCache.CachingHiveMetastoreFactory;
import io.prestosql.plugin.hive.metastore.file.FileHiveMetastore;
import io.prestosql.plugin.hive.metastore.procedure.FlushHiveMetastoreCacheProcedure;
import io.prestosql.plugin.hive.metastore.recording.RecordingHiveMetastoreDecoratorModule;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        newExporter(binder).export(HiveMetastoreFactory.class)
                .as(generator -> generator.generatedNameOf(FileHiveMetastore.class));
