...
public class TestStatementBuilder
{
    ...
    public void testStatementBuilder()
    {
        ...
        printStatement("cache table foo where a = b");
        ...
        printStatement("insert overwrite foo select * from abc");
        ...
        printStatement("insert overwrite t select * from t");
        printStatement("insert into t (c1, c2) select * from t");
        printStatement("insert overwrite t (c1, c2) select * from t");
