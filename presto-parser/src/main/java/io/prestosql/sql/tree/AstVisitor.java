...
public abstract class AstVisitor<R, C>
{
    ...
    public R visitAssignmentItem(AssignmentItem node, C context)
    {
        return visitStatement(node, context);
    }

    public R visitVacuumTable(VacuumTable node, C context)
    {
        return visitStatement(node, context);
    }
    ...
    protected R visitCache(Cache node, C context)
    {
        return visitStatement(node, context);
    }

    protected R visitShowCache(ShowCache node, C context)
    {
        return visitStatement(node, context);
    }

    protected R visitDropCache(DropCache node, C context)
    {
        return visitStatement(node, context);
    }
