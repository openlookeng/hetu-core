        ...
        extends Statement
{
    ...
    public ShowViews(Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        this(Optional.empty(), schema, likePattern, escape);
    }

    public ShowViews(NodeLocation location, Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        this(Optional.of(location), schema, likePattern, escape);
    }

    private ShowViews(Optional<NodeLocation> location, Optional<QualifiedName> schema, Optional<String> likePattern, Optional<String> escape)
    {
        super(location);
    ...
    {
        return visitor.visitShowViews(this, context);
    }
