...
public final class RenameIndex
        extends Statement
{
    ...
    public RenameIndex(QualifiedName source, QualifiedName target, boolean exists)
    {
        this(Optional.empty(), source, target, exists);
    }

    public RenameIndex(NodeLocation location, QualifiedName source, QualifiedName target, boolean exists)
    {
        this(Optional.of(location), source, target, exists);
    }

    private RenameIndex(Optional<NodeLocation> location, QualifiedName source, QualifiedName target, boolean exists)
    {
        super(location);
    ...
    {
        return visitor.visitRenameIndex(this, context);
    }
