        ...
        implements RowDecoder
{
    ...
    public HashRedisRowDecoder(final Map<DecoderColumnHandle, RedisFieldDecoder<String>> fieldDecoders)
    {
        this.fieldDecoders = ImmutableMap.copyOf(fieldDecoders);
    }

    @Override
    public Optional<Map<DecoderColumnHandle, FieldValueProvider>> decodeRow(final byte[] data, final Map<String, String> dataMap)
    {
        if (dataMap == null) {
