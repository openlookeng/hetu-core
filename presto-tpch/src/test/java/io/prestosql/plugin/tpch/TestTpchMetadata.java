...
public class TestTpchMetadata
{
    ...
    public void testPartTypeAndPartContainerPredicatePushdown()
    {
        ...
        assertTupleDomainEquals(result.getRemainingFilter(), TupleDomain.all(), session);
        assertTupleDomainEquals(
                PredicateUtils.filterOutColumnFromPredicate(((TpchTableHandle) result.getHandle()).getConstraint(), tpchMetadata.toColumnHandle(PartColumn.CONTAINER)),
                domain,
                session);
        ...
        assertTupleDomainEquals(result.getRemainingFilter(), TupleDomain.all(), session);
        assertTupleDomainEquals(
                PredicateUtils.filterOutColumnFromPredicate(((TpchTableHandle) result.getHandle()).getConstraint(), tpchMetadata.toColumnHandle(PartColumn.TYPE)),
                domain,
                session);
