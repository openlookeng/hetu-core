 ...
 */
package io.hetu.core.metastore.jdbc.mysql;
...
public class TestJdbcHetuMetastore
{
    ...
    public void setUp()
            throws Exception
    {
        database = new TestingMysqlDatabase(user, password, "jdbcmetastore");
    ...
    public void testAllDatabases()
    {
        ...
        ImmutableList.Builder<DatabaseEntity> databases = ImmutableList.builder();
        ...
        assertTrue(metastore.getAllDatabases(defaultCatalog.getName()).size() > 1);
        assertEquals(databases.build(), ImmutableList.of(db40, db401));
    }
    ...
    public void alterDatabase()
    {
        ...
        DatabaseEntity newDb = DatabaseEntity.builder(db50).setParameters(properties).build();
