...
public class ReadOnlySecurityModuleTest
{
    private ReadOnlySecurityModule readOnlySecurityModuleUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        readOnlySecurityModuleUnderTest = new ReadOnlySecurityModule();
    }
    ...
    public void testConfigure() throws Exception
    {
        ...
        // Run the test
        readOnlySecurityModuleUnderTest.configure(binder);
