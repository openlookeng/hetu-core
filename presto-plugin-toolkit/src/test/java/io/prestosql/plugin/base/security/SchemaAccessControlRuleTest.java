...
public class SchemaAccessControlRuleTest
{
    ...
    public void testMatch() throws Exception
    {
        // Setup
        // Run the test
        final Optional<Boolean> result = schemaAccessControlRuleUnderTest.match("user",
                new HashSet<>(Arrays.asList("value")), "schema");
