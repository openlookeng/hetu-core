...
public class ConnectorAccessControlModuleTest
{
    private ConnectorAccessControlModule connectorAccessControlModuleUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        connectorAccessControlModuleUnderTest = new ConnectorAccessControlModule();
    }
    ...
    {
        // Setup
        ConnectorAccessControl connectorAccessControl = new ConnectorAccessControl() {
        };
        ...
        // Run the test
        connectorAccessControlModuleUnderTest.configure(binder);
