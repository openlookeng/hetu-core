...
@Aspect
@Component
public class SpiDataSerializerHookAspect
{
    ...
    @Around("execution(* com.hazelcast.spi.impl.SpiDataSerializerHook.createFactory())")
    public DataSerializableFactory aroundCreateFactory(ProceedingJoinPoint joinPoint)
    {
        return new DataSerializableFactory() {
            ...
            public IdentifiedDataSerializable create(int typeId)
            {
                switch (typeId) {
                    ...
                    case KERBEROS_TOKEN_CRED:
                        return new KerberosTokenCredentials();
                    default:
                        return null;
                }
            }
