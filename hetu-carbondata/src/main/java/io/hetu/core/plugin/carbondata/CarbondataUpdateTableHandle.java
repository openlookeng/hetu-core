...
public class CarbondataUpdateTableHandle
        extends HiveUpdateTableHandle
        implements ConnectorUpdateTableHandle
{
    private final Map<String, String> additionalConf;

    @JsonCreator
    public CarbondataUpdateTableHandle(@JsonProperty("schemaName") String schemaName,
