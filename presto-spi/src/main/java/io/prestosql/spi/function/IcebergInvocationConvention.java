...
public class IcebergInvocationConvention
{
    ...
    public static IcebergInvocationConvention simpleConvention(InvocationReturnConvention returnConvention, InvocationArgumentConvention... argumentConventions)
    {
        return new IcebergInvocationConvention(Arrays.asList(argumentConventions), returnConvention, false, false);
    }

    public IcebergInvocationConvention(
    ...
    {
        this.argumentConventionList = requireNonNull(argumentConventionList, "argumentConventionList is null");
    ...
    public boolean equals(Object o)
    {
        ...
        IcebergInvocationConvention that = (IcebergInvocationConvention) o;
