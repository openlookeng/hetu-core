...
import static io.prestosql.spi.function.RoutineCharacteristics.Determinism.NOT_DETERMINISTIC;
import static io.prestosql.spi.function.RoutineCharacteristics.Language.JDBC;
import static io.prestosql.spi.function.RoutineCharacteristics.NullCallClause.CALLED_ON_NULL_INPUT;
...
public class RoutineCharacteristics
{
    ...
    {
        this.language = language.orElse(JDBC);
