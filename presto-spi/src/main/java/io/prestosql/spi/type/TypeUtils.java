...
public final class TypeUtils
{
     ...
     * Get the native value as an object in the value at {@code position} of {@code block}.
     */
    public static String readNativeValueForDynamicFilter(Type type, Block block, int position)
    {
        Class<?> javaType = type.getJavaType();
        String value = null;
        if (block.isNull(position)) {
            ...
            value = String.valueOf(type.getDouble(block, position));
        }
        else if (javaType == boolean.class) {
            value = String.valueOf(type.getBoolean(block, position));
        }
