...
public class TypeOperators
{
    ...
    public MethodHandle getEqualOperator(Type type, IcebergInvocationConvention callingConvention)
    {
    ...
    public MethodHandle getHashCodeOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isComparable()) {
            throw new UnsupportedOperationException(type + " is not comparable");
        }
    ...
    public MethodHandle getXxHash64Operator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isComparable()) {
            throw new UnsupportedOperationException(type + " is not comparable");
        }
    ...
    public MethodHandle getDistinctFromOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isComparable()) {
            throw new UnsupportedOperationException(type + " is not comparable");
        }
    ...
    public MethodHandle getIndeterminateOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isComparable()) {
            throw new UnsupportedOperationException(type + " is not comparable");
        }
    ...
    public MethodHandle getComparisonUnorderedLastOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isOrderable()) {
    ...
    public MethodHandle getComparisonUnorderedFirstOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isOrderable()) {
            throw new UnsupportedOperationException(type + " is not orderable");
        }
    ...
    public MethodHandle getOrderingOperator(Type type, SortOrder sortOrder, IcebergInvocationConvention callingConvention)
    {
        if (!type.isOrderable()) {
            throw new UnsupportedOperationException(type + " is not orderable");
        }
    ...
    public MethodHandle getLessThanOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isOrderable()) {
            throw new UnsupportedOperationException(type + " is not orderable");
        }
    ...
    public MethodHandle getLessThanOrEqualOperator(Type type, IcebergInvocationConvention callingConvention)
    {
        if (!type.isOrderable()) {
            throw new UnsupportedOperationException(type + " is not orderable");
        }
    ...
    private OperatorAdaptor getOperatorAdaptor(Type type, IcebergInvocationConvention callingConvention, OperatorType operatorType)
    {
        return getOperatorAdaptor(type, Optional.empty(), callingConvention, operatorType);
    }

    private OperatorAdaptor getOperatorAdaptor(Type type, Optional<SortOrder> sortOrder, IcebergInvocationConvention callingConvention, OperatorType operatorType)
    {
        OperatorConvention operatorConvention = new OperatorConvention(type, operatorType, sortOrder, callingConvention);
        OperatorAdaptor operatorAdaptor = null;
        operatorAdaptor = (OperatorAdaptor) cache.apply(operatorConvention, () -> new OperatorAdaptor(functionAdapter, operatorConvention));
        return operatorAdaptor;
    }
    ...
    private class OperatorAdaptor
    {
        ...
        {
            IcebergInvocationConvention comparisonCallingConvention;
            if (operatorConvention.getCallingConvention().getArgumentConventions().equals(Collections.unmodifiableList(Arrays.asList(BLOCK_POSITION, BLOCK_POSITION)))) {
    ...
    private static final class OperatorConvention
    {
        ...
        public OperatorConvention(Type type, OperatorType operatorType, Optional<SortOrder> sortOrder, IcebergInvocationConvention callingConvention)
        {
