...
public class IntArrayBlockBuilder
        implements BlockBuilder<Integer>
{
    ...
    {
        IntArrayBlockBuilderState myState = new IntArrayBlockBuilderState();
        if (blockBuilderStatus != null) {
    ...
    {
        IntArrayBlockBuilderState myState = (IntArrayBlockBuilderState) state;
    ...
    private static class IntArrayBlockBuilderState
