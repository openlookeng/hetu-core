        ...
        extends AbstractArrayBlock<T>
{
    ...
    public int hashCode()
    {
        return Objects.hash(INSTANCE_SIZE, arrayOffset, positionCount, Arrays.hashCode(valueIsNull), values, Arrays.hashCode(offsets), sizeInBytes, retainedSizeInBytes);
    }
}
