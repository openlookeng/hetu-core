...
public class ShortArrayBlockBuilder
        implements BlockBuilder<Block<Short>>
{
    ...
    {
        ShortArrayBlockBuilderState myState = new ShortArrayBlockBuilderState();
    ...
    {
        ShortArrayBlockBuilderState myState = (ShortArrayBlockBuilderState) state;
    ...
    private static class ShortArrayBlockBuilderState
