        ...
        implements Block<T>
{
    ...
    {
        /* ignoring offset and length: getting from the block directly!
         *  Keeping interface similar to other types so added! */
        return getRawSlice(position)
                .toString(getPositionOffset(position), getSliceLength(position), Charset.forName("UTF-8"));
    }
