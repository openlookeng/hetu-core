        ...
        implements ErrorCodeSupplier
{
    ...
    CATALOG_NOT_EMPTY(0x0000_002C, USER_ERROR),
    TYPE_MISMATCH(0x0000_002D, USER_ERROR),
    INVALID_ROW_FILTER(0x0000_002E, USER_ERROR),
    INVALID_COLUMN_MASK(0x0000_002F, USER_ERROR),
    ...
    UNSUPPORTED_TABLE_TYPE(0x0002_000B, EXTERNAL),
    INVALID_MATERIALIZED_VIEW_PROPERTY(0x0002_000C, USER_ERROR),
    EXPRESSION_NOT_CONSTANTS(0x0002_000D, USER_ERROR),
    TABLE_REDIRECTION_ERROR(0x0002_000E, USER_ERROR),
    DUPLICATE_PROPERTY(0x0002_000F, USER_ERROR),
    INVALID_ARGUMENTS(0x0002_0010, USER_ERROR),
    CATALOG_NOT_FOUND(0x0002_0011, USER_ERROR),
    TABLE_NOT_FOUND(0x0002_0012, USER_ERROR),
    /**/;

    // Connectors can use error codes starting at the range 0x0100_0000
    // See https://github.com/hetu/hetu-core/wiki/Error-Codes
