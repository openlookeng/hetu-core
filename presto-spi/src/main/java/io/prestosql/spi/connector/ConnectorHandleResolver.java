...
public interface ConnectorHandleResolver
{
    ...
    default Class<? extends ConnectorUpdateTableHandle> getUpdateTableHandleClass()
    {
        throw new UnsupportedOperationException();
    }

    default Class<? extends ConnectorVacuumTableHandle> getVacuumTableHandleClass()
    {
        throw new UnsupportedOperationException();
    }
    ...
    default Class<? extends ConnectorDeleteAsInsertTableHandle> getDeleteAsInsertTableHandleClass()
    {
        throw new UnsupportedOperationException();
    }
}
