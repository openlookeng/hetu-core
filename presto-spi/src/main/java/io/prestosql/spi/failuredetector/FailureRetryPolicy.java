...
public interface FailureRetryPolicy
{
    ...
    String FD_RETRY_TYPE = "failure.recovery.retry.type";
    String FD_RETRY_PROFILE = "failure.recovery.retry.profile";
    ...
    // FailureRetryPolicy type names, to be used in profile parameter failure.recovery.retry.type
