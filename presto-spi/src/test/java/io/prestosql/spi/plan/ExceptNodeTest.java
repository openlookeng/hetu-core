...
public class ExceptNodeTest
{
    @Mock
    private PlanNodeId mockId;

    private ExceptNode exceptNodeUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        initMocks(this);
        exceptNodeUnderTest = new ExceptNode(mockId, Arrays.asList(),
    ...
    public void testAccept() throws Exception
    {
        ...
        // Run the test
        exceptNodeUnderTest.accept(visitor, context);
    ...
    public void testReplaceChildren() throws Exception
    {
        ...
        // Run the test
        final PlanNode result = exceptNodeUnderTest.replaceChildren(newChildren);
