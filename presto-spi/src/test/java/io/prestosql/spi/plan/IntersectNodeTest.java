...
public class IntersectNodeTest
{
    ...
    private IntersectNode intersectNodeUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        initMocks(this);
        intersectNodeUnderTest = new IntersectNode(mockId, Arrays.asList(),
    ...
    public void testAccept() throws Exception
    {
        ...
        // Run the test
        intersectNodeUnderTest.accept(visitor, context);
    ...
    public void testReplaceChildren() throws Exception
    {
        ...
        // Run the test
        final PlanNode result = intersectNodeUnderTest.replaceChildren(newChildren);
