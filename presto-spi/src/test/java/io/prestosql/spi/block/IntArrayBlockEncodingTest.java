...
public class IntArrayBlockEncodingTest
{
    private IntArrayBlockEncoding intArrayBlockEncodingUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        intArrayBlockEncodingUnderTest = new IntArrayBlockEncoding();
    }

    @Test
    public void testGetName() throws Exception
    {
        assertEquals("INT_ARRAY", intArrayBlockEncodingUnderTest.getName());
    }
    ...
    public void testWriteBlock1()
    {
        ...
        // Run the test
        intArrayBlockEncodingUnderTest.writeBlock(null, sliceOutput, block);
    ...
    public void testReadBlock1()
    {
        ...
        // Run the test
        final Block result = intArrayBlockEncodingUnderTest.readBlock(null, sliceInput);
    ...
    public void testWrite() throws Exception
    {
        ...
        final IntArrayBlock block = new IntArrayBlock(0, Optional.of(new boolean[]{false}), new int[]{0});

        // Run the test
        intArrayBlockEncodingUnderTest.write(kryo, output, block);
