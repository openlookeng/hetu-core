...
public class RowBlockEncodingTest
{
    private RowBlockEncoding rowBlockEncodingUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        rowBlockEncodingUnderTest = new RowBlockEncoding();
    }

    @Test
    public void testGetName() throws Exception
    {
        assertEquals("ROW", rowBlockEncodingUnderTest.getName());
    }
    ...
    public void testWriteBlock1()
    {
        ...
        // Run the test
        rowBlockEncodingUnderTest.writeBlock(blockEncodingSerde, sliceOutput, block);
    ...
    public void testReadBlock1()
    {
        ...
        // Run the test
        final Block result = rowBlockEncodingUnderTest.readBlock(blockEncodingSerde, sliceInput);
    ...
    public void testReadBlock2()
    {
        ...
        // Run the test
        final Block result = rowBlockEncodingUnderTest.readBlock(blockEncodingSerde, inputStream);
    ...
    public void testWriteBlock2() throws Exception
    {
        ...
        // Run the test
        rowBlockEncodingUnderTest.writeBlock(blockEncodingSerde, outputStream, block);
