...
public class SingleMapBlockEncodingTest
{
    @Mock
    private TypeManager mockTypeManager;

    private SingleMapBlockEncoding singleMapBlockEncodingUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        initMocks(this);
        singleMapBlockEncodingUnderTest = new SingleMapBlockEncoding(mockTypeManager);
    }

    @Test
    public void testGetName() throws Exception
    {
        assertEquals("MAP_ELEMENT", singleMapBlockEncodingUnderTest.getName());
    }
    ...
    public void testWriteBlock1()
    {
        ...
        // Run the test
        singleMapBlockEncodingUnderTest.writeBlock(blockEncodingSerde, sliceOutput, block);
    ...
    public void testReadBlock1()
    {
        ...
        // Run the test
        final Block result = singleMapBlockEncodingUnderTest.readBlock(blockEncodingSerde, sliceInput);
    ...
    public void testWriteBlock2() throws Exception
    {
        ...
        // Run the test
        singleMapBlockEncodingUnderTest.writeBlock(blockEncodingSerde, outputStream, block);
