...
public class RunLengthBlockEncodingTest
{
    private RunLengthBlockEncoding runLengthBlockEncodingUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        runLengthBlockEncodingUnderTest = new RunLengthBlockEncoding();
    }

    @Test
    public void testGetName() throws Exception
    {
        assertEquals("RLE", runLengthBlockEncodingUnderTest.getName());
    }
    ...
    public void testWriteBlock1()
    {
        ...
        // Run the test
        runLengthBlockEncodingUnderTest.writeBlock(blockEncodingSerde, sliceOutput, block);
    ...
    public void testReadBlock1()
    {
        ...
        // Run the test
        final RunLengthEncodedBlock result = runLengthBlockEncodingUnderTest.readBlock(blockEncodingSerde, sliceInput);
    ...
    public void testWriteBlock2() throws Exception
    {
        ...
        // Run the test
        runLengthBlockEncodingUnderTest.writeBlock(blockEncodingSerde, outputStream, block);
