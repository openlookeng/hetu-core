...
public class TimestampTypeTest
{
    ...
    {
        // Run the test
        final TimestampType result = TimestampType.createTimestampWithTimeZoneType(0);
        ...
        assertEquals(0L, result.getLong(block1, 0));
        ...
        assertEquals(0L, result.hash(block3, 0));
...
//                result.getTypeOperatorDeclaration(typeOperators));
    ...
    @Test
    public void testCreateTimestampType() throws Exception
    {
        // Run the test
        final TimestampType result = TimestampType.createTimestampType(0);
        final Block block = null;
        assertEquals("result", result.getObjectValue(null, block, 0));
        assertTrue(result.equals("other"));
        assertEquals(0, result.hashCode());
