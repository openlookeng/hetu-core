...
public class SqlVarbinaryTest
{
    private SqlVarbinary sqlVarbinaryUnderTest;
    ...
    {
        assertEquals(0, sqlVarbinaryUnderTest.hashCode());
    }

    @Test
    public void testEquals() throws Exception
    {
        assertTrue(sqlVarbinaryUnderTest.equals("obj"));
    }

    @Test
    public void testToString() throws Exception
    {
        assertEquals("result", sqlVarbinaryUnderTest.toString());
    }
}
