...
import io.hetu.core.plugin.iceberg.TableType;
...
import static io.hetu.core.plugin.iceberg.TableType.FILES;
import static io.hetu.core.plugin.iceberg.TableType.HISTORY;
import static io.hetu.core.plugin.iceberg.TableType.MANIFESTS;
import static io.hetu.core.plugin.iceberg.TableType.PARTITIONS;
import static io.hetu.core.plugin.iceberg.TableType.PROPERTIES;
import static io.hetu.core.plugin.iceberg.TableType.SNAPSHOTS;
import static io.hetu.core.plugin.iceberg.catalog.glue.GlueMetastoreMethod.CREATE_TABLE;
import static io.hetu.core.plugin.iceberg.catalog.glue.GlueMetastoreMethod.GET_DATABASE;
import static io.hetu.core.plugin.iceberg.catalog.glue.GlueMetastoreMethod.GET_TABLE;
        ...
        extends AbstractTestQueryFramework
{
    ...
    protected TestIcebergGlueCatalogAccessOperations(QueryRunnerSupplier supplier)
    {
        super(supplier);
    }
