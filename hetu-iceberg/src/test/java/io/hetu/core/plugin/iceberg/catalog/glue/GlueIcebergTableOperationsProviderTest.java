...
public class GlueIcebergTableOperationsProviderTest
{
    @Mock
    ...
    private GlueIcebergTableOperationsProvider glueIcebergTableOperationsProviderUnderTest;

    @BeforeMethod
    public void setUp()
    {
        initMocks(this);
        glueIcebergTableOperationsProviderUnderTest = new GlueIcebergTableOperationsProvider(mockFileIoProvider,
                mockStats, mockGlueConfig, mockCredentialsProvider);
    }
    ...
    public void testCreateTableOperations()
    {
        ...
        // Run the test
        final IcebergTableOperations result = glueIcebergTableOperationsProviderUnderTest.createTableOperations(null,
