...
public class IcebergCatalogModuleTest
{
    private IcebergCatalogModule icebergCatalogModuleUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        icebergCatalogModuleUnderTest = new IcebergCatalogModule(Optional.empty());
    }
    ...
    public void testSetup()
    {
        ...
        // Run the test
        icebergCatalogModuleUnderTest.setup(binder);
