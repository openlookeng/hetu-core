...
public class IcebergParquetColumnIOConverterTest
{
    @Test
    public void testConstructField()
    {
        ...
        IcebergParquetColumnIOConverter.FieldContext fieldContext = new IcebergParquetColumnIOConverter.FieldContext(type, columnIdentity);
        IcebergParquetColumnIOConverter.constructField(context, null);
