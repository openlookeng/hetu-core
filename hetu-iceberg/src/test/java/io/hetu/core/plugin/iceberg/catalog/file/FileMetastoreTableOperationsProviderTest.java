...
public class FileMetastoreTableOperationsProviderTest
{
    @Mock
    private FileIoProvider mockFileIoProvider;

    private FileMetastoreTableOperationsProvider fileMetastoreTableOperationsProviderUnderTest;

    @BeforeMethod
    public void setUp()
    {
        initMocks(this);
        fileMetastoreTableOperationsProviderUnderTest = new FileMetastoreTableOperationsProvider(mockFileIoProvider);
    }
    ...
    public void testCreateTableOperations()
    {
        ...
        // Run the test
        final IcebergTableOperations result = fileMetastoreTableOperationsProviderUnderTest.createTableOperations(
