...
import static io.hetu.core.plugin.iceberg.PartitionTransforms.epochDay;
import static io.hetu.core.plugin.iceberg.PartitionTransforms.epochHour;
import static io.hetu.core.plugin.iceberg.PartitionTransforms.epochMonth;
import static io.hetu.core.plugin.iceberg.PartitionTransforms.epochYear;
...
public class TestPartitionTransforms
{
    ...
    {
        StringType type = StringType.get();
        Transform<Object, Object> identity = Transforms.identity(type);
        assertEquals(identity.toString(), "identity");
