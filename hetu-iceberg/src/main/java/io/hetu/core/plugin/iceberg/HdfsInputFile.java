        ...
        implements InputFile
{
    ...
    {
        return environment.doAs(identity.getUser(), delegate::getLength);
    }
    ...
    public SeekableInputStream newStream()
    {
        ...
        return new HdfsInputStream(environment.doAs(identity.getUser(), delegate::newStream));
    }
    ...
    {
        return environment.doAs(identity.getUser(), delegate::exists);
    }
