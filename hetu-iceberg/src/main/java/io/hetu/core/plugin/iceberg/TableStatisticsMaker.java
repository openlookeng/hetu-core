...
public class TableStatisticsMaker
{
    ...
    private TableStatistics makeTableStatistics(IcebergTableHandle tableHandle, Constraint constraint)
    {
        ...
        Map<Integer, IcebergColumnHandle> idToColumnHandle = Collections.unmodifiableMap(
                columnHandles.stream().collect(
                        Collectors.toMap(IcebergColumnHandle::getId, identity())));
        ...
        for (IcebergColumnHandle columnHandle : idToColumnHandle.values()) {
            ...
            if (summary.getColumnSizes() != null) {
                columnSize = summary.getColumnSizes().get(fieldId);
                if (columnSize != null) {
            ...
            columnBuilder.setDistinctValuesCount(Estimate.of(recordCount)); //todo zqj
            ...
            Map<Integer, ColumnFieldDetails> fieldDetails)
    {
        ...
        verify(!constraint.predicate().isPresent(), "Unexpected Constraint predicate");
    ...
    private static class ColumnFieldDetails
    {
        ...
        private final io.prestosql.spi.type.Type trinoType;
        private final Class<?> javaClass;

        public ColumnFieldDetails(PartitionField field, IcebergColumnHandle columnHandle, Type icebergType, io.prestosql.spi.type.Type trinoType, Class<?> javaClass)
        {
        ...
        public io.prestosql.spi.type.Type getTrinoType()
        {
            return trinoType;
        }
