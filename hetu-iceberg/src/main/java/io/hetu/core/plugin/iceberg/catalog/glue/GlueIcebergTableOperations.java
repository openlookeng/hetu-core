...
import io.hetu.core.plugin.iceberg.catalog.AbstractIcebergTableOperations;
        ...
        extends AbstractIcebergTableOperations
{
    ...
    protected String getRefreshedLocation()
    {
        ...
        if (metadataLocation == null) {
            throw new PrestoException(ICEBERG_INVALID_METADATA, format("Table is missing [%s] property: %s", METADATA_LOCATION_PROP, getSchemaTableName()));
        }
