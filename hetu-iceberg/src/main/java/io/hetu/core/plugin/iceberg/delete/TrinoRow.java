...
import static io.hetu.core.plugin.iceberg.IcebergPageSink.getIcebergValue;
        ...
        implements StructLike
{
    ...
    {
        Object object = getIcebergValue(page.getBlock(i), position, types[i]);
    ...
    {
        return () -> new AbstractIterator<TrinoRow>() {
