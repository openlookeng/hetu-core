...
See [Coordinator Kerberos Authentication](../security/server.md) and [CLI Kerberos Authentication](../security/cli.md) for information on setting up Kerberos authentication.
