...
public abstract class AbstractTestOrcReader
{
            ...
            throws Exception
    {
        ...
        List<SqlTimestamp> values = ImmutableList.of(
                new SqlTimestamp(0),
                new SqlTimestamp(10),
                new SqlTimestamp(1123456789L), // 1970-01-14T00:04:16.789Z
                new SqlTimestamp(1000123456789L), // 2001-09-10T12:04:16.789Z
                new SqlTimestamp(1575553299564L)); // 2019-12-05T13:41:39.564Z
