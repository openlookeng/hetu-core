...
import static io.prestosql.orc.metadata.statistics.StringStatisticsBuilder.StringCompactor.truncateMax;
import static io.prestosql.orc.metadata.statistics.StringStatisticsBuilder.StringCompactor.truncateMin;
        ...
        extends AbstractStatisticsBuilderTest<StringStatisticsBuilder, Slice>
{
    ...
    public void testMixingAddValueAndMergeWithLimit()
    {
        ...
        StringStatisticsBuilder statisticsBuilder = new StringStatisticsBuilder(7, false);
        statisticsList.add(statisticsBuilder.buildColumnStatistics());
        assertMergedStringStatistics(statisticsList, 0, 0);
        ...
        statisticsBuilder = new StringStatisticsBuilder(7, false);
        statisticsList.add(statisticsBuilder.buildColumnStatistics());
        assertMergedStringStatistics(statisticsList, 0, 0);
    ...
    private static void assertMinMaxValuesWithLimit(Slice expectedMin, Slice expectedMax, List<Slice> values, int limit)
    {
        ...
        StringStatisticsBuilder builder = new StringStatisticsBuilder(limit, false);
