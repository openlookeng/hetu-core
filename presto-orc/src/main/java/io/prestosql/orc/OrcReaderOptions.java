...
public class OrcReaderOptions
{
    ...
    private static final DataSize DEFAULT_MAX_MERGE_DISTANCE = new DataSizeOfUtil(1, MEGABYTE);
    private static final DataSize DEFAULT_MAX_BUFFER_SIZE = new DataSizeOfUtil(8, MEGABYTE);
    private static final DataSize DEFAULT_TINY_STRIPE_THRESHOLD = new DataSizeOfUtil(8, MEGABYTE);
    private static final DataSize DEFAULT_STREAM_BUFFER_SIZE = new DataSizeOfUtil(8, MEGABYTE);
    private static final DataSize DEFAULT_MAX_BLOCK_SIZE = new DataSizeOfUtil(16, MEGABYTE);
