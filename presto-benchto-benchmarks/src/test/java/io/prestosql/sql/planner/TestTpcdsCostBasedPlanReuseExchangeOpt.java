...
public class TestTpcdsCostBasedPlanReuseExchangeOpt
        extends AbstractCostBasedPlanTest
{
    ...
    public TestTpcdsCostBasedPlanReuseExchangeOpt()
    {
        super(() -> {
            String catalog = "hive";
    ...
    public TestTpcdsCostBasedPlanReuseExchangeOpt(LocalQueryRunnerSupplier supplier, boolean pushdown, boolean cteReuse)
    {
        super(supplier, pushdown, cteReuse);
    }

    @Override
    protected Stream<String> getQueryResourcePaths()
    {
        return IntStream.of(1, 4, 11, 24, 30, 33, 44, 56, 58, 60, 61, 66, 74, 75, 78, 80, 81, 88, 90)
                .boxed()
                .flatMap(i -> {
    ...
    public static final class UpdateTestFiles
    {
        ...
        public static void main(String[] args)
                throws Exception
        {
            new TestTpcdsCostBasedPlanReuseExchangeOpt().generate();
        }
    }
}
