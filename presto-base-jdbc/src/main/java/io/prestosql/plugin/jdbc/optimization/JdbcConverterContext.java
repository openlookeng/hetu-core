...
public class JdbcConverterContext
{
    ...
    public void setRemoteUdfVisited(boolean remoteUdfVisited)
    {
        this.remoteUdfVisited = remoteUdfVisited;
    }
    ...
    public void setDefaultFunctionVisited(boolean defaultFunctionVisited)
    {
        this.defaultFunctionVisited = defaultFunctionVisited;
    }
}
