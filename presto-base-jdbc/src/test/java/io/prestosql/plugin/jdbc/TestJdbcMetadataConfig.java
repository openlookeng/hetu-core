...
public class TestJdbcMetadataConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("metadata-cache-enabled", "false")
                .put("metadata-cache-ttl", "500ms")
                .put("metadata-cache-maximum-size", "9999")
                .build();

        JdbcMetadataConfig expected = new JdbcMetadataConfig()
                .setAllowDropTable(true)
                .setMetadataCacheEnabled(false)
                .setMetadataCacheTtl(new Duration(500, TimeUnit.MILLISECONDS))
                .setMetadataCacheMaximumSize(9999);
