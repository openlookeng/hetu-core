...
{
    private static final DataSize DEFAULT_MAX_READ_BLOCK_SIZE = DataSizeOfUtil.of(16, MEGABYTE);
    private static final DataSize DEFAULT_MAX_MERGE_DISTANCE = DataSizeOfUtil.of(1, MEGABYTE);
    private static final DataSize DEFAULT_MAX_BUFFER_SIZE = DataSizeOfUtil.of(8, MEGABYTE);
