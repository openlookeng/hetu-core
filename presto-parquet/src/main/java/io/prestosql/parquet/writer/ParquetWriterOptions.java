...
{
    private static final DataSize DEFAULT_MAX_ROW_GROUP_SIZE = new DataSize(ParquetWriter.DEFAULT_BLOCK_SIZE, DataSize.Unit.BYTE);
    private static final DataSize DEFAULT_MAX_PAGE_SIZE = new DataSize(ParquetWriter.DEFAULT_PAGE_SIZE, DataSize.Unit.BYTE);
