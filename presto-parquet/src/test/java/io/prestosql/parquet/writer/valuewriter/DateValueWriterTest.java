...
public class DateValueWriterTest
{
    @Mock
    private ValuesWriter mockValuesWriter;

    private DateValueWriter dateValueWriterUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        initMocks(this);
        dateValueWriterUnderTest = new DateValueWriter(mockValuesWriter,
    ...
    public void testWrite()
    {
        ...
        // Run the test
        dateValueWriterUnderTest.write(block);
