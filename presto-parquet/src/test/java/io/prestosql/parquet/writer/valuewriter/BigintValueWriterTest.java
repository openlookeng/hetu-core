...
public class BigintValueWriterTest
{
    @Mock
    ...
    private BigintValueWriter bigintValueWriterUnderTest;

    @BeforeMethod
    public void setUp() throws Exception
    {
        initMocks(this);
        bigintValueWriterUnderTest = new BigintValueWriter(mockValuesWriter, mockType,
    ...
    public void testWrite()
    {
        ...
        // Run the test
        bigintValueWriterUnderTest.write(block);
