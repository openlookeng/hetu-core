...
import static io.hetu.core.jdbc.OpenLooKengDriver.DRIVER_PRODUCT_TAG;
        ...
        implements DatabaseMetaData
{
    ...
    public String getDatabaseProductName()
            throws SQLException
    {
        return isOpenLooKengProtocol() ? OpenLooKengDriver.PRODUCT_NAME : "Presto";
    }
    ...
    public String getDriverName()
            throws SQLException
    {
        return isOpenLooKengProtocol() ? OpenLooKengDriver.DRIVER_NAME : PrestoDriver.DRIVER_NAME;
    }
    ...
    public String getDriverVersion()
            throws SQLException
    {
        return isOpenLooKengProtocol() ? OpenLooKengDriver.DRIVER_VERSION : PrestoDriver.DRIVER_VERSION;
    }

    @Override
    public int getDriverMajorVersion()
    {
        return isOpenLooKengProtocol() ? OpenLooKengDriver.DRIVER_VERSION_MAJOR : PrestoDriver.DRIVER_VERSION_MAJOR;
    }

    @Override
    public int getDriverMinorVersion()
    {
        return isOpenLooKengProtocol() ? OpenLooKengDriver.DRIVER_VERSION_MINOR : PrestoDriver.DRIVER_VERSION_MINOR;
    }
    ...
    private boolean isOpenLooKengProtocol()
    {
        return connection.getURI().toString().startsWith(DRIVER_PRODUCT_TAG);
    }
}
