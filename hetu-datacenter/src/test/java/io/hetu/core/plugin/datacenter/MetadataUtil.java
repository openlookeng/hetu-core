...
public final class MetadataUtil
{
    ...
    {
        private final Map<String, Type> types = ImmutableMap.of(StandardTypes.BOOLEAN, BOOLEAN, StandardTypes.BIGINT,
                BIGINT, StandardTypes.INTEGER, INTEGER, StandardTypes.DOUBLE, DOUBLE, StandardTypes.VARCHAR,
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(DataCenterTable.class));
