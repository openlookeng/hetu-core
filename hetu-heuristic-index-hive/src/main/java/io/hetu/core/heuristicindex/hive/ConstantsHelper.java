...
public final class ConstantsHelper
{
     ...
     */
    public static final String HDFS_AUTH_PRINCIPLE = "hive.hdfs.hetu.principal";

    /**
     * The HDFS kerberos keytab property key
     */
    public static final String HDFS_KEYTAB_FILEPATH = "hive.hdfs.hetu.keytab";

    /**
     * Max rows per split property name for HdfsDataSource
     */
    public static final String HDFS_SOURCE_CONCURRENCY = "hetu.filter.datasource.hdfs.maxthreads";
