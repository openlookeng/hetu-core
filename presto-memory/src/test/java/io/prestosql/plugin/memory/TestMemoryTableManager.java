...
public class TestMemoryTableManager
{
    ...
    {
        createTable(0L, 0L);
        assertEquals(pagesStore.getPages(0L, 1, ImmutableList.of(0), 0, OptionalLong.empty(), OptionalDouble.empty()), ImmutableList.of());
    }
    ...
    public void testInsertPage()
    {
        createTable(0L, 0L);
        insertToTable(0L, 0L);
        assertEquals(pagesStore.getPages(0L, 1, ImmutableList.of(0), POSITIONS_PER_PAGE, OptionalLong.empty(), OptionalDouble.empty()).size(), 1);
    }
    ...
    {
        pagesStore.getPages(0L, 1, ImmutableList.of(0), 0, OptionalLong.empty(), OptionalDouble.empty());
    }
    ...
    public void testTryToReadFromEmptyTable()
    {
        createTable(0L, 0L);
        assertEquals(pagesStore.getPages(0L, 1, ImmutableList.of(0), 0, OptionalLong.empty(), OptionalDouble.empty()), ImmutableList.of());
        pagesStore.getPages(0L, 0, ImmutableList.of(0), 42, OptionalLong.empty(), OptionalDouble.empty());
    }
