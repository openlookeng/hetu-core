        ...
        extends AbstractTestQueryFramework
{
    ...
    public TestGreenPlumTypeMapping()
            throws Exception
    {
        this(new TestingPostgreSqlServer("testuser", "tpch"));
    }

    private TestGreenPlumTypeMapping(TestingPostgreSqlServer postgreSqlServer)
    {
        super(() -> createGreenPlumQueryRunner(postgreSqlServer, ImmutableMap.of("greenplum.experimental.array-mapping", "AS_ARRAY"), ImmutableList.of()));
