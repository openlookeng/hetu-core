...
public class FileSystemExchangeStats
{
    ...
    private final ExecutionStats exchangeSinkFinished = new ExecutionStats();
    private final ExecutionStats exchangeSinkAborted = new ExecutionStats();
    ...
    @Managed
    @Nested
    public ExecutionStats getExchangeSinkFinished()
    {
        return exchangeSinkFinished;
    }

    @Managed
    @Nested
    public ExecutionStats getExchangeSinkAborted()
    {
        return exchangeSinkAborted;
    }
